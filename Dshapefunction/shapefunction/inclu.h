...
const int INFNUM = 25; //18;//
const double DMAX = 1.5;            //whether class MFree generate B again ( 0 == yes)
...
void test(const char* filName,T data, size_t size, int num,char* mode)
{
	...
	strcpy(testFile,"/Users/axr8834/desktop/ishemiadata/geometriesSD1/g1/simulation/");
