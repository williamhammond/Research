...
path_geo = '../data/PhysioNet/Case3/Processed/Final/1230/';
path_in = '../data/PhysioNet/Case3/Processed/Simulation/Input/';
path_out = '../data/PhysioNet/Case3/Processed/Simulation/Output/';
...
if is_pacing == 0
    ...
    filename = strcat(path_geo,'Stimulus2.map');
    fid = fopen(filename,'rb');
