...
//*******************************************************
BEMCell::BEMCell( int nNodNum, int nDim):m_nNodSeq (1), m_nEleSeq(1),m_nNodNum( nNodNum),m_nDim(nDim)
{
...
// Constructors/Destructor
//*******************************************************
Tri3Cell::Tri3Cell( int nNodNum, int nDim, int nGauNum,int nsinGauNum):BEMCell(nNodNum,nDim)
{
...
void Tri3Cell::genGau ( int nNum, int nsinNum)
{
	...
	case 3:
	default:
		m_dpGauPoiCor[0] = 0.166666666666667; m_dpGauPoiCor[1] = 0.166666666666667;
		m_dpGauPoiCor[2] = 0.666666666666667; m_dpGauPoiCor[3] = 0.166666666666667;
        m_dpGauPoiCor[4] = 0.166666666666667; m_dpGauPoiCor[5] = 0.666666666666667;
...
*/		m_dpGauPoiWei[0] = 0.333333333333333;
		...
		break;
	case 7:
		m_dpGauPoiCor[0] = 0.101286507323456;m_dpGauPoiCor[1] = 0.101286507323456;
		m_dpGauPoiCor[2] = 0.797426985353087; m_dpGauPoiCor[3] = 0.101286507323456;
		m_dpGauPoiCor[4] = 0.101286507323456; m_dpGauPoiCor[5] = 0.797426985353087;
		m_dpGauPoiCor[6] = 0.470142064105115; m_dpGauPoiCor[7] = 0.470142064105115;
		m_dpGauPoiCor[8] = 0.470142064105115; m_dpGauPoiCor[9] = 0.059715871789770;
		m_dpGauPoiCor[10] = 0.059715871789770; m_dpGauPoiCor[11] = 0.470142064105115;
		m_dpGauPoiCor[12] = 0.333333333333333; m_dpGauPoiCor[13] = 0.333333333333333;
		...
		break;
	case 13:
		m_dpGauPoiCor[0] = 0.479308067841923;m_dpGauPoiCor[1] = 0.260345966079038;
		m_dpGauPoiCor[2] = 0.260345966079038; m_dpGauPoiCor[3] = 0.479308067841923;
		m_dpGauPoiCor[4] = 0.2603459660790386; m_dpGauPoiCor[5] = 0.260345966079038;
		m_dpGauPoiCor[6] = 0.869739794195568; m_dpGauPoiCor[7] = 0.065130102902216;
		m_dpGauPoiCor[8] = 0.065130102902216; m_dpGauPoiCor[9] = 0.869739794195568;
		m_dpGauPoiCor[10] = 0.065130102902216; m_dpGauPoiCor[11] = 0.065130102902216;
		m_dpGauPoiCor[12] = 0.638444188569809; m_dpGauPoiCor[13] = 0.312865496004875;
		m_dpGauPoiCor[14] = 0.638444188569809; m_dpGauPoiCor[15] = 0.04869031542532;
		m_dpGauPoiCor[16] = 0.312865496004875; m_dpGauPoiCor[17] = 0.638444188569809;
		m_dpGauPoiCor[18] = 0.312865496004875; m_dpGauPoiCor[19] = 0.04869031542532;
		m_dpGauPoiCor[20] = 0.04869031542532; m_dpGauPoiCor[21] = 0.638444188569809;
		m_dpGauPoiCor[22] = 0.04869031542532; m_dpGauPoiCor[23] = 0.312865496004875;
		m_dpGauPoiCor[24] = 0.333333333333333; m_dpGauPoiCor[25] = 0.333333333333333;
...
void Tri3Cell::norG ()
{
	...
	m_nG = sqrt ( m_dpNor[0]*m_dpNor[0] + m_dpNor[1]*m_dpNor[1] + m_dpNor[2]*m_dpNor[2]);
...
void Tri3Cell::gauQua_sur(double* data_S,double h,double s,double wr,double ws)
{
	m_dpSha[0] = 1 - h - s;
    m_dpSha[1] = h;
    m_dpSha[2] = s;
...
//******ordinary**************************************************
void Tri3Cell::gauQua_normal ( BEM& bem, int isFirst, double* data_K, double* data_P, double h,double s, double wr, double ws)
{
	m_dpSha[0] = 1 - h - s;
    m_dpSha[1] = h;
    m_dpSha[2] = s;
	...
	// x = h1*x1 + h2*x2 + h3*x3;
	double x = m_dpSha[0]*m_dpNodCor[0] + m_dpSha[1]*m_dpNodCor[3] + m_dpSha[2]*m_dpNodCor[6];
	double y = m_dpSha[0]*m_dpNodCor[1] + m_dpSha[1]*m_dpNodCor[4] + m_dpSha[2]*m_dpNodCor[7];
	double z = m_dpSha[0]*m_dpNodCor[2] + m_dpSha[1]*m_dpNodCor[5] + m_dpSha[2]*m_dpNodCor[8];
	...
	double temp_k = -(x*m_dpNor[0] + y*m_dpNor[1] + z*m_dpNor[2])*wr*m_nG*0.5/ (4* PI*r*r*r);
...
//****normal for test**********************************
void Tri3Cell::gauQua_normal (double* data_K, double* data_P, double h,double s, double wr, double ws)
{
	m_dpSha[0] = 1 - h - s;
    m_dpSha[1] = h;
    m_dpSha[2] = s;
...
//************************singular*************************
void Tri3Cell::gauQua_sin(double* data_K, double* data_P, double h,double s, double wr, double ws )
{
	h = 0.5+0.5*h;
	s = 0.5+0.5*s;
	m_dpSha[0] = 1 - h - s*(1-h);
...
void Tri3Cell::surInt()
{
	for(int i=0; i<m_nGauNum;i++)
		gauQua_sur(m_dpsinS,m_dpGauPoiCor[i*2],m_dpGauPoiCor[i*2+1],m_dpGauPoiWei[i]);
}
//****for the formal BEM computatoin
void Tri3Cell::numInt (BEM& bem, int isFirst)
{
	 for ( int i = 0; i < m_nGauNum; i++)
	 	  gauQua_normal(bem, isFirst, m_dpsinK, m_dpsinP,m_dpGauPoiCor[i*2],m_dpGauPoiCor[i*2+1],m_dpGauPoiWei[i]);
}
...
{
	 for ( int i = 0; i < m_nGauNum; i++)
	 	  gauQua_normal(m_dpsinK, m_dpsinP,m_dpGauPoiCor[i*2],m_dpGauPoiCor[i*2+1],m_dpGauPoiWei[i]);
}
...
*/
	...
	for (i=0; i<m_nDim; i++)
	{
		if (m_dpNodCor[3*i] == m_dpPoiCor[0] && m_dpNodCor[3*i+1] == m_dpPoiCor[1] &&
	...
	{	for( int k=0; k<m_nSinGauNum;k++)
		...
		//	gauQua(m_dpsinP,m_dpRecGauPoiCor[j],m_dpRecGauPoiCor[k],m_dpRecGauPoiWei[j],m_dpRecGauPoiWei[k],'G',1);
			...
			gauQua_sin(m_dpsinK,m_dpsinP,m_dpRecGauPoiCor[j],m_dpRecGauPoiCor[k],m_dpRecGauPoiWei[j],m_dpRecGauPoiWei[k]);
		}
	}
